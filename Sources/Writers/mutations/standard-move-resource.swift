...
public struct StandardMoveResource: Sendable, Codable, Hashable {
...
public struct StandardMoveResourceState: Sendable, Codable, Hashable {
    public let url: URL
...
public struct StandardMovePlan: Sendable, Codable, Hashable {
